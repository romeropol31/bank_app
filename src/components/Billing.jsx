  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        invoicing. </h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Within a moment you can check everything about your bank account, every transaction you have made. Also we provide a checker for your payments</p>
